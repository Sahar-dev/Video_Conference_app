...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            EventBus.getDefault().post(new EventNotifier(remoteMessage.getData().get("roomName"), remoteMessage.getData().get("username")));
    ...
    private void sendRegistrationToServer(String token) {
        Log.d("Token update","REFRESHING TOKEN...");
        SharedPreferenceHelper sharedPreferenceHelper = new SharedPreferenceHelper();
        tokenService = new TokenService();
        tokenService.updateToken(sharedPreferenceHelper.getString(MyUtils.USER_ID_KEY), token);
    }
